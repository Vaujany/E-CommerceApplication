    ...
    public class MookBookRepository : IBookRepository
    {
        ...
        public IEnumerable<Book> GetAllBooks()
        {
            return new List<Book>()
            {
                 ...
                 ImageUrl="https://images-na.ssl-images-amazon.com/images/I/51p6wBow%2B3L._SX389_BO1,204,203,200_.jpg",InStock=true,ShortDescription="Big data management is one of the major challenges facing business, industry, and not-for-profit organizations",Price=98,CategoryId=1,Category=_category.GetCategoryById(1)
            },
